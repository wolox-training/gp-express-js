...
describe('user', () => {
  ...
  describe('/admin/users POST', () => {
    ...
    it('errorShould successfully POST when an adminUser registers an user how admin', done => {
      // Given
      const adminUser2 = {
        firstName: 'admin',
        lastName: 'admin',
    ...
    it('xxxxxShould successfully POST when an adminUser registers an user how admin', done => {
      // Given
      const adminUser2 = {
        firstName: 'admin',
        lastName: 'admin',
